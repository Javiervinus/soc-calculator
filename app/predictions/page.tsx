...
export default async function PredictionsPage() {
  ...
  // Prefetch de datos necesarios para la página en paralelo
  await Promise.all([
    // Configuración solar
    ...
    // Preferencias del usuario (incluye parámetros de predicción)
    queryClient.prefetchQuery({
    ...
    // Prefetch del caché de predicciones recientes (opcional, para mejorar UX)
    queryClient.prefetchQuery({
      queryKey: ['solar-predictions-cache-recent'],
      queryFn: async () => {
        ...
        const { data } = await supabase
          ...
          .lte('prediction_date', tomorrowStr)
